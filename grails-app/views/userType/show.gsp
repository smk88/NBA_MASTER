...
<html>
	...
	<body>
		...
		<div id="show-userType" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:userTypeInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${userTypeInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
