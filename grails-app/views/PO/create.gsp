...
<html>
	...
	<body>
		<a href="#create-PO" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-PO" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:POInstance, action:'save']" >
				<fieldset class="form">
